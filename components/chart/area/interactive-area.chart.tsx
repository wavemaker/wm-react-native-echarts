...
/**
 * Props for the InteractiveAreaChart component.
 * A taller area chart designed for displaying more data points with multiple series and interactive tooltips.
 */
  ...
  const option = useMemo(() => {
    ...
    return {
      ...
      series: data.map((item, index) => ({
        ...
        lineStyle: {
          color: theme.series[index % theme.series.length].color,
          width: theme.series[index].lineWidth,
        },
      })),
    };

...
/**
 * Props for the DefaultAreaChart component.
 * A basic area chart with a smooth curve and filled area below the line.
 */
interface DefaultAreaChartProps {
  /**
   ...
   * @default [150, 230, 180, 120, 200, 250]
   */
  data?: number[];
...
export const DefaultAreaChart = withResponsiveContainer(withChartTheme(ChartComponent));

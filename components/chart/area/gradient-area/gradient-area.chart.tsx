...
/**
 * Props for the GradientAreaChart component.
 * An area chart with multiple series, each with gradient-filled areas.
 */
...
export const GradientAreaChart = withResponsiveContainer(withChartTheme(ChartComponent));

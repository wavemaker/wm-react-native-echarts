...
/**
 * Props for the IconsAreaChart component.
 * An area chart with circular markers (icons) at each data point.
 */
interface IconsAreaChartProps {
  /**
      ...
      series: data.map((s, index) => ({
        ...
        areaStyle: {
          ...
          color: {
            ...
            y2: 1,
            colorStops: [
              { offset: 0, color: theme.series[index % theme.series.length].color + '66' },
              { offset: 1, color: theme.series[index % theme.series.length].color + '66' },
            ],
          },
        },
        itemStyle: {
...
export const IconsAreaChart = withResponsiveContainer(withChartTheme(ChartComponent));

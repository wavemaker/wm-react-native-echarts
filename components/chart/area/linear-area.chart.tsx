...
/**
 * Props for the LinearAreaChart component.
 * An area chart with linear (straight line) interpolation between data points.
 */
interface LinearAreaChartProps {
   ...
   * @default [180, 220, 240, 160, 190, 270]
   */
  data?: number[];
...
export const LinearAreaChart = withResponsiveContainer(withChartTheme(ChartComponent));

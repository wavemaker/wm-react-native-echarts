...
import { LinesOnlyRadarChart } from './lines-only-radar.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Radar/LinesOnlyRadarChart',
  component: LinesOnlyRadarChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof LinesOnlyRadarChart>;

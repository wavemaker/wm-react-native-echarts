...
import { GridFilledRadarChart } from './grid-filled-radar.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Radar/GridFilledRadarChart',
  component: GridFilledRadarChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof GridFilledRadarChart>;

...
import { CustomLabelRadarChart } from './custom-label-radar.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Radar/CustomLabelRadarChart',
  component: CustomLabelRadarChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof CustomLabelRadarChart>;

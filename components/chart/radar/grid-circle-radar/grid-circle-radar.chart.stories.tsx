...
import { GridCircleRadarChart } from './grid-circle-radar.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Radar/GridCircleRadarChart',
  component: GridCircleRadarChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof GridCircleRadarChart>;

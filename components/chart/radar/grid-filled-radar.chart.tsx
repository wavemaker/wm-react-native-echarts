...
/**
 * Props for the GridFilledRadarChart component.
 * A radar chart with polygonal grid and filled area.
 */
          ...
          data: [
            {
              ...
              itemStyle: { color: theme.series[0].color, opacity: 0 },
              lineStyle: { width: 0 },
            },
          ],
        },
...
export const GridFilledRadarChart = withResponsiveContainer(withChartTheme(ChartComponent));

...
import { GridNoneRadarChart } from './grid-none-radar.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Radar/GridNoneRadarChart',
  component: GridNoneRadarChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof GridNoneRadarChart>;

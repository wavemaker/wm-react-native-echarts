...
/**
 * Props for the GridCircleRadarChart component.
 * A radar chart with circular grid lines.
 */
...
export const GridCircleRadarChart = withResponsiveContainer(withChartTheme(ChartComponent));

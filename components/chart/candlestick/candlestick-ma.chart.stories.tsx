...
import { CandlestickMAChart } from './candlestick-ma.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Candlestick/CandlestickMAChart',
  component: CandlestickMAChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof CandlestickMAChart>;
...
const sampleXAxisData = Array.from(

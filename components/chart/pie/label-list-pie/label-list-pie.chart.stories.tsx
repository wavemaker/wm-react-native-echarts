...
import { LabelListPieChart } from './label-list-pie.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Pie/LabelListPieChart',
  component: LabelListPieChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof LabelListPieChart>;

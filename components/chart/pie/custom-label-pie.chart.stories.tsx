...
import { CustomLabelPieChart } from './custom-label-pie.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Pie/CustomLabelPieChart',
  component: CustomLabelPieChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof CustomLabelPieChart>;

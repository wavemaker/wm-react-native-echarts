...
import { SeparatorNonePieChart } from './separator-none-pie.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Pie/SeparatorNonePieChart',
  component: SeparatorNonePieChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof SeparatorNonePieChart>;

...
/**
 * Props for the LinearLineChart component.
 * A line chart with linear (straight line) interpolation between data points.
 */
...
export const LinearLineChart = withResponsiveContainer(withChartTheme(ChartComponent));

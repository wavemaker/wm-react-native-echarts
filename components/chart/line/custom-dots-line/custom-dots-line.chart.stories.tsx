...
import { CustomDotsLineChart } from './custom-dots-line.chart';
import { View, StyleSheet } from 'react-native';
import React from 'react';

const meta = {
  title: 'Charts/Line/CustomDotsLineChart',
  component: CustomDotsLineChart,
  parameters: {
    layout: 'centered',
  },
  tags: ['autodocs'],
...
} satisfies Meta<typeof CustomDotsLineChart>;

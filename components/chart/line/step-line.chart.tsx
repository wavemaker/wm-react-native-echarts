...
/**
 * Props for the StepLineChart component.
 * A line chart with step interpolation creating a staircase pattern.
 */
...
export const StepLineChart = withResponsiveContainer(withChartTheme(ChartComponent));

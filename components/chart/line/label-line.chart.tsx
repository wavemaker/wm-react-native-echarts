...
/**
 * Props for the LabelLineChart component.
 * A line chart with value labels displayed at each data point.
 */
...
export const LabelLineChart = withResponsiveContainer(withChartTheme(ChartComponent));

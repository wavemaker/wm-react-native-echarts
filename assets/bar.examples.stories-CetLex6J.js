...
}`,...(x=(p=r.parameters)==null?void 0:p.docs)==null?void 0:x.source},description:{story:`Bar chart with axes labels matching axes-area.png.
...
Features: Chrome (top, longest) to Other (bottom, shortest), light-to-dark blue gradient, no axes or grid, rounded bar ends.`,...(Q=(K=m.parameters)==null?void 0:K.docs)==null?void 0:Q.description}}};const fe=["AxesBar","DefaultBar","HorizontalBar","MultipleSeries","GDPContribution","ActiveBar","CustomLabelBar","MixedBar"];export{l as ActiveBar,r as AxesBar,c as CustomLabelBar,i as DefaultBar,o as GDPContribution,n as HorizontalBar,m as MixedBar,t as MultipleSeries,fe as __namedExportsOrder,ge as default};

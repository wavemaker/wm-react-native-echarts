import{R as g,r as b}from"./iframe-DQBbESXd.js";import{s as ee,T as Y,w as oe,u as le,c as ae,a as se,b as ue,i as de,V as G,S as ce}from"./install-D_wEXfzl.js";import{T as pe,a as me,b as fe,c as he,C as ge,d as _}from"./use-axis-tooltip-I7UAJfpW.js";import{i as ye,e as J,p as Q}from"./echarts-legend-layout-B14L7phv.js";import{i as be,c as te}from"./common-WjgByzXx.js";import{i as Ce}from"./install-JQrd69Od.js";import{l as xe}from"./legend-position-CLb_FM1L.js";function Z(t){if(!Array.isArray(t)||t.length===0)return!1;const e=t[0];return"data"in e&&Array.isArray(e.data)&&"radius"in e&&Array.isArray(e.radius)}ee.create({ring:{fontSize:11,fontWeight:"600",marginBottom:4,textTransform:"uppercase"},title:{fontWeight:"600",fontSize:13,flex:1},line:{fontSize:12,marginTop:2},swatch:{width:8,height:8,borderRadius:4,marginRight:6},swatchPlaceholder:{width:8,height:8,marginRight:6}});function ke(t){const{name:e,value:r,percent:o,color:n,ringName:i}=t;return g.createElement(he,{eyebrow:i!=null&&i!==""?i:void 0,header:{swatchColor:n,title:e,marginBottom:6}},g.createElement(Y,{style:{fontSize:14,fontWeight:"700",color:"#0f172a"}},r," ",g.createElement(Y,{style:{fontWeight:"500",color:"#64748b"}},"(",o.toFixed(1),"%)")))}function ve(t){const{name:e,value:r,percent:o}=t;return g.createElement(fe,{emphasis:e,detail:`${r} (${o.toFixed(1)}%)`,wrap:!0})}function we(t){const{name:e,value:r,percent:o,color:n}=t;return g.createElement(me,{accentColor:n??"#3b82f6",minWidth:140,overline:e,metric:String(r),caption:`${o.toFixed(1)}% of total`})}function Se(t){const{name:e,value:r,percent:o,color:n}=t;return g.createElement(pe,{headerSwatch:{color:n??"#64748b",title:e},rows:[{key:"value",leftLabel:"value",right:String(r)},{key:"share",leftLabel:"share",right:`${o.toFixed(1)}%`}]})}function We(t){switch(t){case"card":return e=>ke(e);case"compact":return e=>ve(e);case"kpi":return e=>we(e);case"striped":return e=>Se(e)}throw new Error(`Unknown tooltip preset: ${String(t)}`)}function qe(t,e){if(typeof(e==null?void 0:e.dataIndexInside)=="number"&&!Number.isNaN(e.dataIndexInside))return e.dataIndexInside;if(typeof(e==null?void 0:e.dataIndex)=="number"&&!Number.isNaN(e.dataIndex)){const r=typeof(t==null?void 0:t.indexOfRawIndex)=="function"?t.indexOfRawIndex(e.dataIndex):e.dataIndex;if(typeof r=="number"&&!Number.isNaN(r))return r}return null}function Te(t,e){var c;const r=(c=t.getItemLayout)==null?void 0:c.call(t,e);if(!r||!Number.isFinite(r.cx)||!Number.isFinite(r.cy))return null;const o=Number(r.cx),n=Number(r.cy),i=Number(r.r),s=Number(r.r0??0),l=Number(r.startAngle),a=Number(r.endAngle);if(!Number.isFinite(l)||!Number.isFinite(a))return null;const C=(l+a)/2,u=(s+i)/2;return{x:o+Math.cos(C)*u,y:n+Math.sin(C)*u}}function Ne(t,e,r,o,n){const i=e==null?void 0:e.x,s=e==null?void 0:e.y;return typeof i=="number"&&typeof s=="number"&&!Number.isNaN(i)&&!Number.isNaN(s)?{x:i,y:s}:Te(o,n)}function re(t,e){var n,i;try{const s=typeof t.mapDimension=="function"?t.mapDimension("value"):null;if(s!=null){const l=t.get(s,e),a=Number(l);if(Number.isFinite(a))return a}}catch{}const r=(n=t.get)==null?void 0:n.call(t,0,e),o=Number(r);if(Number.isFinite(o))return o;try{const s=Number((i=t.get)==null?void 0:i.call(t,"value",e));if(Number.isFinite(s))return s}catch{}return NaN}function Pe(t){const e=typeof t.count=="function"?t.count():0;let r=0;for(let o=0;o<e;o++){const n=re(t,o);Number.isFinite(n)&&(r+=n)}return r}function Re(t,e,r,o){var D,F,B,V,z,p,y,f,d,W;if(!t||!e||Array.isArray(e.dataByCoordSys)&&e.dataByCoordSys.length>0)return null;const n=e.seriesIndex;if(typeof n!="number"||n<0)return null;const i=(B=(D=t.getModel)==null?void 0:(F=D.call(t)).getSeriesByIndex)==null?void 0:B.call(F,n),s=(i==null?void 0:i.subType)??((V=i==null?void 0:i.get)==null?void 0:V.call(i,"type"));if(!i||s!=="pie")return null;const l=(z=i.getData)==null?void 0:z.call(i);if(!l)return null;const a=qe(l,e);if(a==null||a<0)return null;const C=Ne(t,e,i,l,a);if(!C)return null;const u=r.normalizedSeries[n],c=(p=u==null?void 0:u.data)==null?void 0:p[a];if(!c)return null;const q=String(((y=l.getName)==null?void 0:y.call(l,a))??c.name??""),S=re(l,a),m=Number.isFinite(S)?S:Number(c.value),x=Pe(l),I=x>0?m/x*100:0;let k;try{const v=(f=l.getItemVisual)==null?void 0:f.call(l,a,"style"),E=v==null?void 0:v.fill;typeof E=="string"&&E!==""&&(k=E)}catch{}if(k==null){const v=Math.max(o.length,1);k=(d=o[a%v])==null?void 0:d.color}const L=(W=i.get)==null?void 0:W.call(i,"name"),T=typeof L=="string"&&L!==""?L:(u==null?void 0:u.name)!=null&&u.name!==""?String(u.name):void 0;return{pointerX:C.x,pointerY:C.y,seriesIndex:n,dataIndex:a,name:q,value:m,percent:I,...typeof k=="string"?{color:k}:{},...T!=null?{ringName:T}:{}}}function Ie(t){const{active:e,renderTooltip:r,contextRef:o,themeSeriesRef:n,width:i,height:s}=t,[l,a]=b.useState(null);b.useEffect(()=>{e||a(null)},[e]);const C=b.useCallback(c=>{if(!e)return()=>{};const q=m=>{var k;const x=o.current;if(!((k=x==null?void 0:x.normalizedSeries)!=null&&k.length)){a(null);return}const I=Re(c,m,x,n.current??[]);a(I)},S=()=>a(null);return c.on("showTip",q),c.on("hideTip",S),()=>{c.off("showTip",q),c.off("hideTip",S)}},[e,o,n]),u=b.useCallback(()=>!e||l==null?null:g.createElement(ge,{width:i,height:s,pointerX:l.pointerX,pointerY:l.pointerY},r(l)),[e,r,l,i,s]);return{attachPieItemTooltipListeners:C,renderPieTooltipOverlay:u}}le([be,ye,ae,Ce]);const ie=({data:t,width:e=220,height:r=350,radius:o="75%",showLegend:n=!0,legendPosition:i="bottom",showLabel:s=!0,labelPosition:l="outside",showLabelLine:a=!0,showHighlighter:C=!0,tooltip:u="card",renderTooltip:c,onSelect:q,...S})=>{const{theme:m}=ue(S.theme,S.colors),x=b.useRef(null),I=b.useRef(q);I.current=q;const k=b.useRef({normalizedSeries:[]}),L=b.useRef(m.series);L.current=m.series;const T=c!=null||u!=="none",D=b.useMemo(()=>c??(u==="none"?()=>null:We(u)),[c,u]),{attachPieItemTooltipListeners:F,renderPieTooltipOverlay:B}=Ie({active:T,renderTooltip:D,contextRef:k,themeSeriesRef:L,width:e,height:r}),V=b.useMemo(()=>!Array.isArray(t)||t.length===0?[]:Z(t)?t.map(f=>({name:f.name,data:f.data.map(d=>({name:d.name,value:d.value}))})):[{data:t.map(y=>({name:y.name,value:y.value}))}],[t]);k.current={normalizedSeries:V};const z=b.useMemo(()=>{if(!Array.isArray(t)||t.length===0)return{series:[]};const p=m.series.map(h=>h.color),y={color:m.legend.textColor,fontSize:m.legend.fontSize},f=(h,N,A,O)=>{const P=h.reduce((R,w)=>R+w.value,0),U=s?{show:!0,position:l,formatter:R=>{const w=P>0?(R.value/P*100).toFixed(1):"0";return`${R.name}
${w}%`},...y}:{show:!1};return{type:"pie",name:A,radius:(Array.isArray(N),N),...O?{center:O}:{},data:h,label:U,labelLine:{show:s&&(l==="outside"?a:!1),lineStyle:{color:m.legend.textColor}},emphasis:C?{focus:"none",scale:!0,scaleSize:5,itemStyle:{shadowBlur:10,shadowOffsetX:0,shadowColor:"rgba(0, 0, 0, 0.2)"}}:{disabled:!0}}};if(Z(t)){const h=t,N=Q(i,n);let A=0;const O=h.map(w=>{const $=w.data.map(j=>{var M;return{name:j.name,value:j.value,itemStyle:(M=j.itemStyle)!=null&&M.color?{color:j.itemStyle.color}:{color:p[A++%p.length]}}});return f($,w.radius,w.name,N)}),P=n?Array.from(new Set(h.flatMap(w=>w.data.map($=>$.name)))):void 0,R={tooltip:T?{trigger:"item",..._()}:{show:!1},series:O};return P!=null&&P.length&&(R.legend={data:P,...J(i),textStyle:y,backgroundColor:m.legend.backgroundColor}),R}const W=t.map((h,N)=>{var A;return{name:h.name,value:h.value,itemStyle:(A=h.itemStyle)!=null&&A.color?{color:h.itemStyle.color}:{color:p[N%p.length]}}}),v=Q(i,n),E=f(W,o,void 0,v),ne=T?{trigger:"item",..._()}:{show:!1},H=n?{data:W.map(h=>h.name),...J(i),textStyle:y,backgroundColor:m.legend.backgroundColor}:void 0,K={tooltip:ne,series:[E]};return H&&(K.legend=H),K},[t,o,n,i,s,l,a,C,T,m]);return b.useEffect(()=>{let p,y=()=>{};if(x.current)try{p=de(x.current,"light",{width:e,height:r}),p.setOption(z),y=F(p);const f=d=>{const W=I.current;if(typeof W!="function"||d.componentType!=="series"||d.seriesType!=="pie"||typeof d.dataIndex!="number"||d.dataIndex<0||d.name==null)return;const v={seriesIndex:d.seriesIndex??0,dataIndex:d.dataIndex,name:String(d.name),value:Number(d.value??0),seriesName:d.seriesName,percent:d.percent};W(v)};p.on("click",f)}catch(f){console.warn("Pie chart initialization error:",f)}return()=>{if(y(),p)try{p.dispose()}catch(f){console.warn("Pie chart disposal error:",f)}}},[z,e,r,F]),g.createElement(G,{style:{width:e,height:r,position:"relative"}},g.createElement(ce,{ref:x,useRNGH:!0}),B())},Le=oe(se(ie),"data"),Ae=Object.assign(Le,{displayName:"PieChart"});ie.__docgenInfo={description:"",methods:[],displayName:"ChartComponent",props:{width:{required:!1,tsType:{name:"number"},description:`Width of the chart in pixels.

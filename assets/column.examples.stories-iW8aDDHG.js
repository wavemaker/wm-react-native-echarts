...
Features: vertical bars, Jan–Jun x-axis labels, horizontal grid, no y-axis labels, light blue bars.`,...(x=(p=r.parameters)==null?void 0:p.docs)==null?void 0:x.description}}};var d,b,h,A,g;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
...
}`,...(h=(b=i.parameters)==null?void 0:b.docs)==null?void 0:h.source},description:{story:`Column chart with value labels on top of each bar, matching label-bar.png.
...
Features: 11 vertical blue bars, date labels on x-axis (Apr–Jun), horizontal grid, tooltip on interaction.`,...(N=(C=o.parameters)==null?void 0:C.docs)==null?void 0:N.description}}};var D,O,z,R,I;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
...
Features: zero baseline, bars up (positive) and down (negative), light blue for positive and darker blue for negative, Jan–Jun labels, horizontal grid.`,...(I=(R=l.parameters)==null?void 0:R.docs)==null?void 0:I.description}}};const ce=["StandardColumn","LabelColumn","MultipleSeries","ActiveColumn","InteractiveColumn","NegativeColumn"];export{n as ActiveColumn,o as InteractiveColumn,i as LabelColumn,t as MultipleSeries,l as NegativeColumn,r as StandardColumn,ce as __namedExportsOrder,le as default};

...
/** Column chart with axes labels matching axes-area.png.
 * Features: Y-axis 0-600, X-axis months (Jan-Jun), grid lines, axis labels. */
export const AxesColumn: Story = {
  args: {
...
/** Column chart without axes, matching default-area.png.
...
/**
 * Column chart showing GDP of top economies over the last decade (2014-2024).
